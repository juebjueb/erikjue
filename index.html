	...
	<div class="container">
		 <div class="row">
			<div class="col-5 col-lg-4">
				<img src="images/erikjue.png" class="img-fluid" alt="Erik Jue Headshot" style="max-width:80%">
				...
				Grad Research - <a href = "https://ismagilovlab.caltech.edu/"> Ismagilov Lab </a><br /><br />
				
				BS in Bioengineering, UCLA 2014 <br />
				Undergrad Research - <a href = "http://kameilab.seas.ucla.edu/"> Kamei Lab </a></p>
				
				<hr/>
				<h6 class="font-weight-bold"> CONTACT: </h6>
				<p> jue.erik at gmail.com <br />
				<a href="https://www.linkedin.com/in/erikjue/"><img src="images/linkedinlogo.PNG" alt="linkedIn" width="25" height="25"></a>
				</p>
				...
				<hr/>
				<h6 class="font-weight-bold"> I SUPPORT: </h6>
				<p> <a href="https://www.themawandaproject.com/"><img src="images/TMP.png" class="img-fluid" alt="The Mawanda Project" style="max-width:80%"></a></p>
			...
			<div class="col-7 col-lg-8" >
				...
				<div id="myCarousel" class="carousel slide d-none d-md-block" data-ride="carousel" >
					...
					<div class="carousel-inner" align="center">
						<div class="carousel-item active img-fluid">
						  <img class="d-block w-50" src="images/biomarkerConcentration.PNG" alt="PEG-salt phase separation">
						  <div class="carousel-caption  bg-dark mb-4">
							<p>pre-concentrate biomarkers</p>
						  </div>
						</div>
						
						<div class="carousel-item img-fluid">
						  <img class="d-block w-50" src="images/ATPS_flow.PNG" alt="aqueous two phase system on paper">
						  <div class="carousel-caption  bg-dark mb-4">
							<p>phase separation on paper</p>
						  </div>
						</div>
						
						<div class="carousel-item ">
						  <img class="d-block w-50" src="images/meter-mix.PNG" alt="meter-mix device">
						  <div class="carousel-caption bg-dark mb-4">
						...
						<div class="carousel-item">
						  <img class="d-block w-50" src="images/motorheater.PNG" alt="Arduino-controlled motor and heater">
						  <div class="carousel-caption  bg-dark mb-4">
							<p>Arduino controller for motor & heater</p>
						  </div>
						</div>
						
						<div class="carousel-item">
						  <img class="d-block w-50" src="images/cellphone.PNG" alt="cell phone fluorescence">
						  <div class="carousel-caption  bg-dark mb-4">
							<p>cell-phone fluorescence imaging</p>
						  </div>
						</div>		
						
						<div class="carousel-item">
						  <img class="d-block w-50" src="images/autoNAAT.PNG" alt="automated nucleic acid amplification testing">
						  <div class="carousel-caption  bg-dark mb-4">
							<p>automated NA test platform (<30 min)</p>
						  </div>
						</div>
					</div>
				...
				<p class="text-justify"> I am a multidisciplinary engineer and infectious disease diagnostics expert with a propensity for problem solving and a passion for improving global health. I have a natural inclination for taking on difficult challenges and getting things done. Over the years, I have developed a rigorous approach to science and engineering coupled with a deep and broad technical skillset. particularly enjoy leading teams, mentorship, and bringing out the best in others.
				</p>
				...
				<div id="accordion">
				  ...
				  <div class="card">
					<div class="card-header" id="headingOne">
					  <h5 class="mb-0">
						<button class="btn btn-link collapsed text-left" data-toggle="collapse" data-target="#collapseOne" aria-expanded="false" aria-controls="collapseOne">
					...
					<div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordion">
					  <div class="card-body">
						...
						<b>Authors: </b><u>Erik Jue</u> and Rustem F. Ismagilov <br />
				  ...
				  <div class="card">
					...
					<div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion">
					  <div class="card-body">
						...
						<b> Authors: </b> Justin C. Rolando, <u>Erik Jue</u>, Jacob Barlow, and Rustem F. Ismagilov <br />
				  ...
				  <div class="card">
					...
					<div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordion">
					  <div class="card-body">
						...
						<b>Authors: </b> <u>Erik Jue</u>, Daan Witters, and Rustem F. Ismagilov <br />
				  ...
				  <div class="card">
					...
					<div id="collapseFour" class="collapse" aria-labelledby="headingFour" data-parent="#accordion">
					  <div class="card-body">
						...
						<b>Authors: </b> <u>Erik Jue</u>, Nathan G. Schoepp, Daan Witters, and Rustem F. Ismagilov <br />
				  ...
				  <div class="card">
					...
					<div id="collapseFive" class="collapse" aria-labelledby="headingFive" data-parent="#accordion">
					  <div class="card-body">
						...
						<b> Authors: </b> Jesus Rodriguez-Manzano, Mikhail A. Karymov, Stefano Begolo, David A. Selck, Dmitriy V. Zhukov, <u>Erik Jue</u>, and Rustem F. Ismagilov <br />
				  ...
				  <div class="card">
					<div class="card-header" id="headingSix">
					  <h5 class="mb-0">
						<button class="btn btn-link collapsed text-left" data-toggle="collapse" data-target="#collapseSix" aria-expanded="false" aria-controls="collapseSix">
					...
					<div id="collapseSix" class="collapse" aria-labelledby="headingSix" data-parent="#accordion">
					  <div class="card-body">
						...
						<b> Authors: </b> <u>Erik Jue</u>, Cameron D. Yamanishi, Ricky Y.T. Chiu, Benjamin M. Wu, and Daniel T. Kamei <br />
				  ...
				  <div class="card">
					<div class="card-header" id="headingSeven">
					  <h5 class="mb-0">
						<button class="btn btn-link collapsed text-left" data-toggle="collapse" data-target="#collapseSeven" aria-expanded="false" aria-controls="collapseSeven">
					...
					<div id="collapseSeven" class="collapse" aria-labelledby="headingSeven" data-parent="#accordion">
					  <div class="card-body">
						<p>
						<b> Authors: </b> Ricky Y.T. Chiu, <u>Erik Jue</u>, Allison T. Yip, Andrew R. Berg, Stephanie J. Wang, Alexandra R. Kivnick, Phuong T. Nguyen, and Daniel T. Kamei <br />
